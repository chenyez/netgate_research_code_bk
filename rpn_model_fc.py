...
from avod.netgate import chenye_netgate
    ...
    def build(self):
        ...
        with tf.variable_scope('proposal_roi_fusion'):
            ...
            ###############################
                ...
                rpn_fusion_out = chenye_netgate.netgate(bev_proposal_rois, img_proposal_rois, self._is_training) 
            ################################
            ##   Chenye  Netgate end      ##
            ################################
        ...
        with tf.variable_scope('anchor_predictor', 'ap', [rpn_fusion_out]):
            ...
            with slim.arg_scope([slim.fully_connected],
                ...
                cls_fc6 = slim.fully_connected(tensor_in,
                ...
                cls_fc7 = slim.fully_connected(cls_fc6_drop,
                ...
                cls_fc8 = slim.fully_connected(cls_fc7_drop,
                                      2,
                                      activation_fn=None,
                                      scope='cls_fc8')
                ...
                reg_fc6 = slim.fully_connected(tensor_in,
                ...
                reg_fc7 = slim.fully_connected(reg_fc6_drop,
                ...
                reg_fc8 = slim.fully_connected(reg_fc7_drop,
                                      6,
                                      activation_fn=None,
                                      scope='reg_fc8')
