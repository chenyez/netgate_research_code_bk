...
#        np.savetxt("/home/chenye/AVOD/avod/avod/netgate/scalar/scalar_0.txt",scalar_0)
#        np.savetxt("/home/chenye/AVOD/avod/avod/netgate/scalar/scalar_1.txt",scalar_1)
...
#        fused_data=tf.multiply(scalar_0,bev_fc_drop) + tf.multiply(scalar_1,img_fc_drop)
        fused_data=tf.multiply(scalar_0,bev_roi_flat) + tf.multiply(scalar_1,img_roi_flat)
        
        print("fused_data is:",fused_data)
...
#            fused_result=packup_tensors(fused_result,fused_res)
    ...
    return netgate_out#,scalar_fc_drop
