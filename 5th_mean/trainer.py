...
#    prediction_dict,rpn_netgate_scalar = model.build()
...
#            np.savetxt("/home/chenye/AVOD/avod/avod/netgate/scalar/scalar_0.txt",rpn_netgate_scalar.eval())
            #print("bev_proposal_rois,rpn_fusion_out are:",bev_proposal_rois[5:10,:],rpn_fusion_out[5:10,:])
