...
#######################################################################
#                    return tf.reshape(ones_mat * multiplier, [-1]),proposals_shape[:2]
...
#########################################################################
        ...
        with tf.variable_scope('proposal_roi_fusion'):
            ...
            ###############################
                ...
                rpn_fusion_out,num_of_anchors = chenye_netgate.netgate(bev_proposal_rois, img_proposal_rois, self._is_training) 
            ################################
            ##   Chenye  Netgate end      ##
            ################################
